    ...
    <View style={{ flex: 1, backgroundColor: '#fff' }}>
      <View style={styles.headerRow}>
          <IconButton
            ...
            onPress={handleBack}
          />
          <Text style={styles.title}>Preferred Activities</Text>
        </View>
      <ScrollView contentContainerStyle={styles.container}>
        <Text variant="headlineSmall" style={styles.question}>What type of speech activities would {childName} enjoy the most?</Text>
